...
import aboutHero from "../../assets/Tangalle2.jpg";

import dhamma from "../../assets/Udawalawe2.jpg";
import sigiriya from "../../assets/place12.jpg";
import kandy from "../../assets/place17.jpg";
        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="bg-white -py-2">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        Embark on a captivating 15-day journey across Sri Lanka’s most iconic destinations, beginning with the sandy beaches of Negombo and the wildlife-rich Wilpattu National Park. Explore the ancient city of Anuradhapura, then venture north to Jaffna for an immersive cultural experience. Moving south, visit the serene beaches of Trincomalee and Pasikuda before reaching the UNESCO-listed Sigiriya Rock Fortress. Discover Kandy’s spiritual and natural wonders, followed by a scenic journey to Colombo. Conclude with a memorable excursion to Bentota and a Madu River safari, wrapping up an unforgettable exploration of Sri Lanka’s rich heritage, landscapes, and warm hospitality. Perfect for travelers keen on wildlife, history, and coastal beauty!
                    </p>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-xl font-bold">15 Days / 14 Nights</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 space-y-6">
                        ...
                        <div data-aos="fade-up" className="overflow-hidden rounded-lg border bg-white shadow">
                            ...
                            {day1 && (
                                <div className="space-y-4 px-6 py-6 text-gray-700 leading-relaxed">
                                    ...
                                    <p>
                                        Wilpattu National Park Safari: Morning jeep safari to spot wildlife. (Duration: approx. 3 hours)
                                    </p>
                                    ...
                                    <p>
                                        Explore Anuradhapura: Visit sacred sites like the Sri Maha Bodhi tree. (Duration: approx. 3 hours)
                                    </p>
                        ...
                        >
                            ...
                            {day3 && (
                                <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                    ...
                                    <p>
                                        Full Day in Anuradhapura: Continue exploring ancient ruins, including Ruwanwelisaya stupa and Isurumuniya Temple.
                                    </p>
                                    ...
                                    <p>
                                        Visit Local Markets: Experience local culture.
                                    </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            ...
                            {day4 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Explore Jaffna: Visit key sites like the Jaffna Fort and Nallur Kandaswamy Temple. (Duration: approx. 3 hours)
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay5(!day5)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 5: Explore Jaffna</span>
                                <span>{day5 ? "−" : "+"}</span>
                            </button>
                            {day5 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Full Day in Jaffna: Visit local beaches, the Jaffna Library, and Casuarina Beach.
                                </p>
                                ...
                                <p>
                                    Optional Tour: Visit Delft Island (if time permits).
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            ...
                            {day6 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Lunch in Trincomalee.
                                </p>

                                <p>
                                    Visit Koneswaram Temple: Explore the ancient Hindu temple with stunning views. (Duration: approx. 1.5 hours)
                                </p>

                                <p>
                                    Relax at Trincomalee Beach.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay7(!day7)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 7: Explore Trincomalee</span>
                                <span>{day7 ? "−" : "+"}</span>
                            </button>
                            {day7 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Pigeon Island National Park: Snorkeling and beach time. (Duration: approx. 3 hours)
                                </p>
                                ...
                                <p>
                                    Explore Fort Frederick: Visit the fort and surrounding area.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            ...
                            {day8 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Transfer to Pasikuda: Approx. 1.5-hour drive.
                                </p>

                                <p>
                                    Relax at Pasikuda Beach: Enjoy the beautiful beach and water sports.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay9(!day9)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 9: Explore Pasikuda</span>
                                <span>{day9 ? "−" : "+"}</span>
                            </button>
                            {day9 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Full Day at Pasikuda: Beach activities or optional excursions like visiting local fishing villages.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            ...
                            {day10 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Sigiriya Rock Fortress: Climb the Lion Rock and explore the site. (Duration: approx. 3 hours)
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay11(!day11)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 11: Sigiriya to Kandy</span>
                                <span>{day11 ? "−" : "+"}</span>
                            </button>
                            {day11 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Temple of the Sacred Tooth Relic: Visit this UNESCO World Heritage Site. (Duration: approx. 1.5 hours)
                                </p>
                                ...
                                <p>
                                    Explore Peradeniya Botanical Gardens: Stroll through the beautiful gardens. (Duration: approx. 1.5 hours)
                                </p>

                                <p>
                                    Kandyan Cultural Show: Evening traditional dance performance. (Duration: approx. 1 hour)
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay12(!day12)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 12: Explore Kandy</span>
                                <span>{day12 ? "−" : "+"}</span>
                            </button>
                            {day12 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Full Day in Kandy: Visit the Udawatta Kele Sanctuary and local markets.
                                </p>
                                ...
                                <p>
                                    Optional Activities: Visit local crafts shops or tea plantations.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay13(!day13)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 13: Kandy to Colombo</span>
                                <span>{day13 ? "−" : "+"}</span>
                            </button>
                            {day13 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Transfer to Colombo: Approx. 3-hour drive.
                                </p>
                                ...
                                <p>
                                    Colombo City Tour: Explore the capital city’s key sights like Independence Square, Galle Face Green, and local shopping spots.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay14(!day14)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 14: Excursion to Bentota & Madu River</span>
                                <span>{day14 ? "−" : "+"}</span>
                            </button>
                            {day14 && <div className="space-y-5 px-6 py-6 text-gray-700 leading-relaxed">
                                ...
                                <p>
                                    Transfer to Bentota: Approx. 1.5-hour drive.
                                </p>

                                <p>
                                    Madu River Boat Safari: Explore mangroves, fish spas, and local islands. (Duration: approx. 2 hours)
                                </p>

                                <p>
                                    Bentota Beach Relaxation: Spend some time on the beach or enjoy water sports.
                                </p>

                                <p>
                                    Return to Colombo: Approx. 1.5-hour drive back.
                                </p>
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button onClick={() => setDay15(!day15)} className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]">
                                <span>Day 15: Departure from Colombo</span>
                                <span>{day15 ? "−" : "+"}</span>
                            </button>
                    ...
                    >
                        ...
                        <div className="flex flex-col lg:flex-row gap-6">
                            ...
                            <div className="route-info w-full h-[100px] lg:w-[300px] flex flex-col items-start gap-3 rounded-lg bg-gray-100 p-5 text-lg shadow">
                                <p><strong>Distance:</strong> 1,210 km</p>
                                <p><strong>Duration:</strong> 32 hr</p>
                            </div>
